            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form:form class="user" action="${pageContext.request.contextPath}/register/customer" method="POST"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <form:input type="phone" class="form-control form-control-user" path="mobile"
