...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">View and manage customers who have purchased your books. Track their orders and payment status.</p>
              ...
              <c:choose>
                      ...
                      <tbody>
                        <c:forEach items="${customers}" var="customer">
                          <tr>
                            ...
                            <td>
                              <c:choose>
                                <c:when test="${customer.pendingPayments > 0}">
                            ...
                            <td>
                              <button class="btn btn-sm btn-primary" onclick="viewCustomerOrders('${customer.id}')">
                                <i class="fas fa-eye"></i> View Orders
                              </button>
                              <button class="btn btn-sm btn-info" onclick="contactCustomer('${customer.email}')">
                ...
                <c:otherwise>
                  <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">No customers yet</h4>
                    <p class="text-muted">
                      Customers will appear here when they purchase your books.<br>
                      You can track their orders and manage communications.
                    </p>
                    <div class="alert alert-info" role="alert">
                      <i class="fas fa-info-circle"></i>
                      <strong>Customer Management Features:</strong>
                      <ul class="list-unstyled mt-2">
                        <li><i class="fas fa-eye"></i> View customer order history</li>
                        <li><i class="fas fa-money-bill"></i> Track paid and unpaid orders</li>
                        <li><i class="fas fa-envelope"></i> Contact customers directly</li>
                        <li><i class="fas fa-chart-line"></i> Monitor customer spending patterns</li>
                      </ul>
                    </div>
                    <div class="mt-3">
                      <a href="${pageContext.request.contextPath}/seller/books/add" class="btn btn-success btn-lg">
                        <i class="fas fa-plus"></i> Add Books to Attract Customers
                      </a>
                    </div>
                  </div>
                </c:otherwise>
  ...
  <script>
    ...
    function viewCustomerOrders(customerId) {
      alert('View order history for Customer ID: ' + customerId + '\n(Feature to be implemented)');
    }

    function contactCustomer(customerEmail) {
      window.location.href = 'mailto:' + customerEmail + '?subject=Regarding your book order&body=Dear Customer,';
    }
  </script>
