...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Track and manage orders for your books. Handle payment status and customer communications.</p>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">INR ${totalRevenue}</div>
                    </div>
                    <div class="col-auto">
              ...
              <c:choose>
                      ...
                      <tbody>
                        <c:forEach items="${orders}" var="order">
                          <tr>
                            ...
                            <td>
                              <span class="badge badge-${order.paymentMethod == 'COD' ? 'warning' : 'info'}">
                                ${order.paymentMethod}
                              </span>
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <c:if test="${order.paymentStatus == 'Unpaid' && order.paymentMethod == 'COD'}">
                ...
                <c:otherwise>
                  <div class="text-center py-5">
                    ...
                    <p class="text-muted">
                      Orders will appear here when customers purchase your books.<br>
                      You can track payment status and manage deliveries.
                    </p>
                    <div class="alert alert-info" role="alert">
                      <i class="fas fa-info-circle"></i>
                      <strong>Payment Methods Available:</strong>
                      <ul class="list-unstyled mt-2">
                        <li><i class="fas fa-truck"></i> Cash on Delivery (COD) - Mark as paid when delivered</li>
                        <li><i class="fas fa-credit-card"></i> Online Payments (Stripe) - Coming Soon</li>
                      </ul>
                    </div>
                  </div>
                </c:otherwise>
  ...
  <script>
    ...
    function markPaid(orderId) {
      if (confirm('Mark this order as paid? This action will update the payment status.')) {
